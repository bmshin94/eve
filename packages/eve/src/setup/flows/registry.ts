  ...
  try {
    ...
    for (const [index, item] of items.entries()) {
      ...
      try {
        ...
        // The diagnostic settles and retains recent command output without
        // exposing bundled internal stack frames in the transcript.
        input.prompter.log.error(failureMessage);
